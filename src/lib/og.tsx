...
async function renderToPng(node: React.ReactElement, context: string): Promise<Buffer> {
  try {
    const serif = loadFont('@fontsource/newsreader/files/newsreader-latin-400-normal.woff');
    const serifItalic = loadFont('@fontsource/newsreader/files/newsreader-latin-400-italic.woff');
