...
export const THREADS: Thread[] = [
  {
    id: 't1',
    title: 'Anyone shipping FP8 in production yet? Mixed bag here.',
    author: 'ana',
    replies: 47,
  ...
  {
    id: 't2',
    title: 'Why does my SFT degrade on long-context after merging adapters?',
    author: 'tom',
    replies: 23,
    lastReply: '1 hr ago',
    category: 'Training',
  ...
  {
    id: 't3',
    title: 'Sparse attention papers worth reading — 2026 thread',
    author: 'lchen',
    replies: 89,
    lastReply: '2 hr ago',
  ...
  {
    id: 't4',
    title: 'vLLM 0.9.x — share your benchmarks',
    author: 'priya',
    replies: 31,
    lastReply: '4 hr ago',
    category: 'Inference',
  ...
  {
    id: 't5',
    title: 'How are you handling KV cache offload to host memory?',
    author: 'mira',
    replies: 18,
    lastReply: '6 hr ago',
    category: 'Inference',
  ...
  {
    id: 't6',
    title: 'Best practices for evaluating world models on offline data',
    author: 'felix',
    replies: 12,
    lastReply: '8 hr ago',
...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    desc: 'Build a structured model card from a checkpoint and an eval log.',
    tag: 'Beta',
    available: false,
  },
  {
    ...
    desc: 'Run a small set of evals against any endpoint, get a scorecard.',
    tag: 'Beta',
    available: false,
  },
  {
    ...
    desc: 'Side-by-side timings for Triton, CUDA, and PyTorch kernels.',
    tag: 'Soon',
    available: false,
  },
];
