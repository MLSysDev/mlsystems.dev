...
{/* mermaid
flowchart TD
  M["a mask = a 0/1 gate<br/><b>ignore this element</b>"]
  M --> S1["<b>SEE</b><br/>attention masks"]
  M --> S2["<b>SCORE</b><br/>loss masks"]
  M --> S3["<b>HIDE</b><br/>objective masks"]
  M --> S4["<b>DROP</b><br/>regularization masks"]
  S1 --> a1["what a token<br/>may attend to"]
  S2 --> a2["what counts<br/>in the loss"]
  S3 --> a3["what's hidden<br/>to create the task"]
  S4 --> a4["what's randomly<br/>zeroed for robustness"]
*/}
<svg class="mermaid-diagram" viewBox="0 0 720 224" role="img" aria-label="A mask is a 0/1 gate; it splits into four families — SEE (attention masks), SCORE (loss masks), HIDE (objective masks), and DROP (regularization masks)." style="width:100%;max-width:720px;height:auto;color:currentColor;font-family:var(--font-mono);">
